...
const Referentiel = lazyRetry(
  () => import('@/pages/Referentiel'),
  'Referentiel'
);
...
const Utilisateurs = lazyRetry(
  () => import('@/pages/Utilisateurs'),
  'Utilisateurs'
);
            ...
            <Suspense fallback={<PageFallback />}>
              <Routes>
                ...
                <Route element={<AppLayout />}>
                  ...
                  <Route
                    path="/donnees"
                    element={<Navigate to="/donnees/primaire" replace />}
                  />
                  ...
                  <Route
                    ...
                    element={
                      <RequireAuth>
                        <Navigate to="/besoins/primaire" replace />
                      </RequireAuth>
                    }
                  />
                  <Route
                  ...
                  <Route
                    path="/tdb/dren"
                    element={<Navigate to="/tdb-dren" replace />}
                  />
                  <Route
                    path="/tdb/cisco"
                    element={<Navigate to="/tdb-cisco" replace />}
                  />
                  <Route
                    path="/tdb/zap"
                    element={<Navigate to="/tdb-zap" replace />}
                  />
                  <Route
                    path="/tdb/ecole"
                    element={<Navigate to="/tdb-ecole" replace />}
                  />
                  <Route
                    path="/utilisateurs"
                    element={
