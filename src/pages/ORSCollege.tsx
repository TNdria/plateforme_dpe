...
const ORSCollege = () => {
  ...
  const filteredColleges = useMemo(
    () =>
      colleges.filter((c) => {
        const secteur = Number(c.SECTEUR);
        return secteur === 0 || secteur === 2 ? layerVisibility.publiques : layerVisibility.prives;
      }),
  ...
  const filteredPrimaires = useMemo(
    () =>
      primaires.filter((p) => {
        const secteur = Number(p.SECTEUR);
        return secteur === 0 || secteur === 2 ? layerVisibility.publiques : layerVisibility.prives;
      }),
              ...
              <CardContent className="px-4 pb-4 pt-0">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <Label htmlFor="tablebanc" className="text-sm cursor-pointer flex-1">
                      Table-bancs
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-muted/50 rounded-lg p-3">
                  ...
                  <div className="font-semibold">
                    {selectedEtablissement.effectifs || selectedEtablissement.eff_2024 || "-"}
                  </div>
                </div>
              </div>
