...
$(document).ready(function () {
        ...
        buttons: [
            {
                ...
                title: 'Donnees_primaires' // Nom du fichier Excel
            }
        ],
        language: {
    ...
    loading_data = async () => {
        ...
        try {
            url_data = `dataPrimaire/${code_dren}/${code_cisco}/${code_commune}/${code_zap}/${secteur}`
            ...
            populateDataTable(table, "Listes des Etablissements Primaires", data, cols)
            ...
            populateDataTable(table_eff, "Effectifs Primaire", data, cols)
            ...
            populateDataTable(table_pers, "Effectifs Primaires", data, cols)
                        
        } catch (error) {
            console.error('Erreur lors de la récuperation des données Ecoles Primaires :', error);
        } finally {
            utils.waitmeClose('div-map')  
        }
