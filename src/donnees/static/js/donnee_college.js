...
$(document).ready(function () {
        ...
        buttons: [
            {
                ...
                title: 'Donnees_colleges' // Nom du fichier Excel
            }
        ],
        language: {
    ...
    loading_data = async () => {
        ...
        try {
            url_data = `dataCollege/${code_dren}/${code_cisco}/${code_commune}/${code_zap}/${secteur}`
            ...
            populateDataTable(table, "Listes des Etablissements Collèges", data, cols)
            ...
            populateDataTable(table_eff, "Effectifs Collège", data, cols)
            ...
            populateDataTable(table_pers, "Effectifs Collèges", data, cols)
                        
        } catch (error) {
            console.error('Erreur lors de la récuperation des données Ecoles Collèges :', error);
        } finally {
            utils.waitmeClose('div-map')  
        }
