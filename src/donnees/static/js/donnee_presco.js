...
$(document).ready(function () {
        ...
        buttons: [
            {
                ...
                title: 'Donnees_prescolaire' // Nom du fichier Excel
            }
        ],
        language: {
    ...
    loading_data = async () => {
        ...
        try {
            url_data = `dataPrescolaire/${code_dren}/${code_cisco}/${code_commune}/${code_zap}/${secteur}`
            ...
            populateDataTable(table, "Listes des Etablissements Préscolaires", data, cols)
            ...
            populateDataTable(table_eff, "Effectifs Préscolaires", data, cols)
            ...
            populateDataTable(table_pers, "Effectifs Préscolaires", data, cols)
                        
        } catch (error) {
            console.error('Erreur lors de la récuperation des DOnnées Ecoles Préscolaires :', error);
        } finally {
            utils.waitmeClose('div-map')  
        }
