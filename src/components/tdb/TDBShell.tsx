  ...
  return (
    <TooltipProvider>
      <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-muted/40 via-background to-muted/30">
        ...
        <div className="sticky top-0 z-30 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 shadow-sm">
          <div className="mx-auto max-w-none px-4 py-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex-1 min-w-[220px]">
                <h1 className="text-base sm:text-lg font-bold leading-tight text-foreground">{computedTitle}</h1>
                <p className="text-xs text-muted-foreground">
                  Ministère de l'Éducation Nationale
                  {annee && <> · Année scolaire <strong className="text-foreground">{annee}</strong></>}
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                {onDownloadPdf && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button size="sm" onClick={onDownloadPdf} disabled={!hasData || generatingPdf}>
                ...
                {onPrint && !isAdmin && (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button size="sm" variant="outline" onClick={onPrint} disabled={!hasData}>
